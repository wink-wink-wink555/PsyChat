...
<details>
<summary><strong>整体工作流流程图  <em>（点击展开查看）</em></strong></summary>
...
这一设计将模糊的"学习风格"指令替换为**结构化的显式约束**，并要求模型在回答前进行**主动的交互策略规划**。
